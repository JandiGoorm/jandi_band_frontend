...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "[팀원초대] 버튼을 통해 초대 코드를 발급 받아 링크를 전달하거나, [카카오톡 공유하기] 버튼을 통해 초대 코드를 공유할 수 있습니다. 이 경우에는 카카오톡 메세지가 전송됩니다. *초대코드는 일주일간 유효합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "[시간표 추가]의 에브리타임 버튼을 통해 시간표를 불러올 수 있습니다. 사용 방법은 가이드를 확인해주세요.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "마이페이지 > 설정 > 회원 탈퇴 메뉴에서 가능합니다. 탈퇴 시 모든 정보가 삭제되며, 탈퇴 후 일주일간 재가입이 불가합니다.",
  },
];
